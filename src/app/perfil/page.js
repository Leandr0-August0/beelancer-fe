...
export default function Config() {
    ...
    return (
        <>
            <Navbar />
            <main>
                <div className="flex flex-row gap-40 grow w-full pt-12 px-40 max-h-full">
                    <div className="selfScroll flex w-1/2 flex-col">
                        <article className="flex flex-col items-start rounded-none w-full">
                            <div className="w-full text-left">
                                <ProfileHeader />
                                <SkillsSection />
                            </div>
                            <hr className=" mt-6 w-full border border-solid border-neutral-400 " />
                            <ReviewSection />
                        </article>
                    </div>
                    <div className="selfScroll flex w-1/2 flex-col px-15 ">
                        <div className="flex flex-col w-full h-full gap-8 py-8 overflow-auto">
                            ...
                            {publis.map((publi) => {
                                ...
                                return (
                                    <div
                                        className="flex flex-col bg-[#d9d9d9] w-full rounded-lg p-4"
                                        key={publi.id}
                                    >
